 ...
 * or {@link MTrimContribution} is on the list of elements capable of being rendered. The annotation's value returns the optionality.  
...
public @interface ContributionRender {
	// whether the contribution is renderable
