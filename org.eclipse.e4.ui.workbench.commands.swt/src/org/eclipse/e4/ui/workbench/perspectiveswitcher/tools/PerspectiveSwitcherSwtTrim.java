...
public class PerspectiveSwitcherSwtTrim implements IPerspectiveSwitcherControl {
	...
	//
	@Inject @Preference(value=E4PerspectiveSwitcherPreferences.SHOW_TEXT, nodePath=E4PerspectiveSwitcherPreferences.ROOT_PREFERENCES_NODE)
	...
	/* (non-Javadoc)
	 * @see org.eclipse.e4.ui.workbench.perspectiveswitcher.tools.IPerspectiveSwitcherControl#setSelectedElement(org.eclipse.e4.ui.model.application.ui.advanced.MPerspective)
	 */
	@Override
	...
	void setShowText(@Preference(value=E4PerspectiveSwitcherPreferences.SHOW_TEXT,
			nodePath=E4PerspectiveSwitcherPreferences.ROOT_PREFERENCES_NODE) boolean showShortcutText) {
